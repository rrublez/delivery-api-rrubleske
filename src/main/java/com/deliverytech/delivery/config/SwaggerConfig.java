 ...
 * Define metadados da API, informações de contato, licença e servidores
 */
@Configuration
  ...
  public OpenAPI customOpenAPI() {
    return new OpenAPI()
        .info(new Info()
            ...
            .version("1.0.0")
            .description("API REST para gerenciar restaurantes, produtos, clientes e pedidos de delivery")
            .contact(new Contact()
