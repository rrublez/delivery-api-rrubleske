...
public final class TestAuthHelper {
  ...
  private TestAuthHelper() {}
    ...
    public static String registerAndLogin(MockMvc mockMvc, ObjectMapper objectMapper, Role role, Long restauranteId) throws Exception {
      return registerAndLoginWithEmail(mockMvc, objectMapper, role, restauranteId).token();
    }

    public static AuthSession registerAndLoginWithEmail(MockMvc mockMvc, ObjectMapper objectMapper, Role role) throws Exception {
      return registerAndLoginWithEmail(mockMvc, objectMapper, role, null);
    }

    public static AuthSession registerAndLoginWithEmail(MockMvc mockMvc, ObjectMapper objectMapper, Role role, Long restauranteId) throws Exception {
      ...
      return new AuthSession(token, email);
    }

    public record AuthSession(String token, String email) {}
}
